...
const errors = {
  invalidDirectory: 'Error: not a valid directory =P',
  noWriteAccess: 'Error: you do not have write access to this directory D:',
...
const commands = {};
let systemData = {};
const rootPath = 'users/ArckramKreator/root';
...
// Create Te quiero .
commands.Te_Quiero = () => errors.Te_Quiero;
